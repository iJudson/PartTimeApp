...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    /* 改变状态栏的颜色为白色
     * 要先在inofo.plist 中设置View controller-based status bar appearance 为YES
     */
...
//        UINavigationController *nvc = [[UINavigationController alloc] init];
        LPMainController *dgbTBVC = [[LPMainController alloc] init];
        self.window.rootViewController = dgbTBVC;
    }else{
