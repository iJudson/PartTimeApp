...
@interface NewforgetCodeViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation NewforgetCodeViewController
...
//            [bquery whereKey:@"username" equalTo:UserNameTextField.text];
//            //            NSTimer *timer = [NSTimer scheduledTimerWithTimeInterval:refreshMaxTime target:self selector:@selector(stopheadImageFile:) userInfo:nil repeats:NO];
...
- (void)setUI
{
    ...
    UILabel *text = [[UILabel alloc] initWithFrame:CGRectMake(logimg.frame.origin.x, UserName.frame.size.height + UserName.frame.origin.y + 12, 58, 37)];
    text.text = @"验证码:";
    text.textColor = [UIColor whiteColor];
    text.textAlignment = NSTextAlignmentLeft;
    [self.view addSubview:text];
    
    UILabel * UserCode = [[UILabel alloc] initWithFrame:CGRectMake(logimg.frame.origin.x, text.frame.size.height + text.frame.origin.y + 12, 58, 37)];
    UserCode.text = @"密  码:";
    ...
    sendv.frame = CGRectMake(UserNameTextField.frame.size.width + UserNameTextField.frame.origin.x - 87, line3.frame.origin.y - 34, 87, 28);
    ...
    SecurityCode = [[UITextField alloc] initWithFrame:CGRectMake(UserCode.frame.origin.x + UserCode.frame.size.width + 5, UserNameTextField.frame.size.height + UserNameTextField.frame.origin.y + 12, sendv.frame.origin.x - (UserCode.frame.origin.x + UserCode.frame.size.width) - 5, 37)];
    ...
    UserCodeTextField = [[UITextField alloc] initWithFrame:CGRectMake(UserCode.frame.origin.x + UserCode.frame.size.width + 5, SecurityCode.frame.size.height + SecurityCode.frame.origin.y + 12, 185, 37)];
    ...
    Goregister = [UIButton buttonWithType:UIButtonTypeSystem];
    Goregister.frame = CGRectMake(Width/2 - 124, UserCodeTextField.frame.size.height + UserCodeTextField.frame.origin.y + 12, 248, 90);
    [Goregister setTitle:@"找回密码" forState:UIControlStateNormal];
