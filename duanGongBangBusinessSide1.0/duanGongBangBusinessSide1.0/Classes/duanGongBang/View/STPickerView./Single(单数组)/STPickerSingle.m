...
//    if (component == 0) {
//        return (ScreenWidth-PickerViewLabelWeight*2)/2;
//    }else if (component == 1){
//        return PickerViewLabelWeight*2;
//    }else {
//        return (ScreenWidth-PickerViewLabelWeight*2)/2;
//    }
...
- (UIPickerView *)pickerView
{
    if (!_pickerView) {
        ...
        CGFloat pickerX = 0;
        CGFloat pickerY = ScreenHeight+STControlSystemHeight + 20;
...
//{
//    if (!_lineView2) {
//        _lineView2 = [[UIView alloc]initWithFrame:CGRectMake(0, 114, ScreenWidth, 0.5)];
//        [_lineView2 setBackgroundColor:RGB(205, 205, 205)];
//    }
//    return _lineView2;
//}
